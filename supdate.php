...
$sql=mysqli_query($conn,"update tbl_sgarments set s_action='$status' where s_id='$s_id'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <input name="Submit2" type="submit" class="txtbox4" value="Close this Window "  onClick="document.location.href='deshome.php';" style="cursor: pointer;"  /></td>
    </tr>
<?php } ?>
</table>
 </form>
