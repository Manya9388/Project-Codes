...
WHERE tbl_order.status = 'Delivered' AND tbl_payment.pay_id=tbl_order.pay_id ");
...
$price=$row['price'];
    ...
    $qus=mysqli_query($conn,"select fname,lname,phone,address,city,region,pincode,district from tbl_oaddress where log_id='$log_id'");
...
<tr>
        ...
        <td><?php echo htmlentities($address);?><br><?php echo htmlentities($city);?><br><?php echo htmlentities($region);?><br><?php echo htmlentities($district);?><br><?php echo htmlentities($pincode);?></td>
