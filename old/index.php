...
<!--						      </p>-->								
					      ...
					      <div class="well">
							<ul class="nav">
								<li class="color-preview" value="White" style="background-color:#ffffff;"></li>
								<li class="color-preview" value="Dark Heather" style="background-color:#616161;"></li>
								<li class="color-preview" value="Gray" style="background-color:#f0f0f0;"></li>
								<li class="color-preview" value="Charcoal" style="background-color:#5b5b5b;"></li>
								<li class="color-preview" value="Black" style="background-color:#222222;"></li>
								<li class="color-preview"value="Heather Orange" style="background-color:#fc8d74;"></li>
								<li class="color-preview" value="Heather Dark Chocolate" style="background-color:#432d26;"></li>
								<li class="color-preview" value="Salmon" style="background-color:#eead91;"></li>
								<li class="color-preview"value="Chesnut" style="background-color:#806355;"></li>
								<li class="color-preview" value="Dark Chocolate" style="background-color:#382d21;"></li>
								<li class="color-preview" value="Citrus Yellow" style="background-color:#faef93;"></li>
								<li class="color-preview"value="Avocado" style="background-color:#aeba5e;"></li>
								<li class="color-preview" value="Kiwi" style="background-color:#8aa140;"></li>
								<li class="color-preview" value="Irish Green" style="background-color:#1f6522;"></li>
								<li class="color-preview"value="Scrub Green" style="background-color:#13afa2;"></li>
								<li class="color-preview" value="Teal Ice" style="background-color:#b8d5d7;"></li>
								<li class="color-preview"value="Heather Sapphire" style="background-color:#15aeda;"></li>
								<li class="color-preview" value="Sky" style="background-color:#a5def8;"></li>
								<li class="color-preview" value="Antique Sapphire" style="background-color:#0f77c0;"></li>
								<li class="color-preview" value="Heather Navy" style="background-color:#3469b7;"></li>							
								<li class="color-preview" value="Cherry Red" style="background-color:#c50404;"></li>
							</ul>
						</div>			      
				     </div>				   
