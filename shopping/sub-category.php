				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=mysqli_query($conn,"select sub_Name  from tbl_subcategory where sub_id='$sub_id'");
while($row=mysqli_fetch_array($sql))
{ 
    ?>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($conn,"select * from tbl_products where sub_id='$sub_id'");
...
while ($row=mysqli_fetch_array($ret)) 
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="product-details.php?product_id=<?php echo htmlentities($row['product_id']);?>"><?php echo htmlentities($row['product']);?></a></h3>
