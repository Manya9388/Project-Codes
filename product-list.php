                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="my_account.php" class="nav-item nav-link">Home</a>
                            <a href="#" class="nav-item nav-link active">Products</a>
                            <a href="#" class="nav-item nav-link">Product Details</a>
            ...
            if($row['status']==0)
{
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            <img src="<?php echo $a ?>" class="card-img-top" height="250">
            <div class="card-body p-1">
              ...
              <h6 class="card-title text-center text-info"><?= $row['quantity'] ?></h6>
            </div>
  ...
  $(document).ready(function() {
    ...
    $(".addItemBtn").click(function(e) {
      ...
      var occassion = $form.find(".occassion").val();
